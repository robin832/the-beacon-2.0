...
const DEFAULT_CONTENT: IndustryContent = {
  ...
  headlines: [
    { title: "Belgian innovation ecosystem expands with new cross-sector partnerships", source: "VLAIO", date: "2025", snippet: "VLAIO reports a 15% year-over-year increase in formal innovation collaborations between Belgian industrial firms and tech scale-ups." },
    { title: "EU Green Deal drives €200B investment in European industrial decarbonization", source: "European Commission", date: "2025", snippet: "Belgian industrial clusters are positioned to capture a significant share of the green transition funding." },
  ],
};
...
export const INDUSTRY_CONTENT: Record<string, IndustryContent> = {
  "Maritime & Port": {
    ...
    headlines: [
      { title: "Port of Antwerp-Bruges launches AI traffic management for inland shipping", source: "Flows.be", date: "2025", snippet: "The port authority deployed a new AI-powered system to optimize barge traffic along the Scheldt corridor, reducing waiting times by up to 25%." },
      { title: "Blue Cluster announces €20M innovation fund for maritime tech scale-ups", source: "Blue Cluster", date: "2025", snippet: "Flemish maritime innovation cluster launches a dedicated fund to accelerate autonomous shipping and green port technology startups." },
      { title: "FuelEU Maritime: what it means for Belgian operators in 2026", source: "EMSA", date: "2025", snippet: "The new regulation on greenhouse gas intensity of fuels applies to all ships above 5,000 GT calling at EU ports from January 2026." },
    ],
  },
  "Chemical & Process Industry": {
    ...
    headlines: [
      { title: "Essenscia reports 12% increase in chemical sector R&D spend for 2024", source: "Essenscia", date: "2025", snippet: "Belgian chemical federation highlights the sector's continued commitment to innovation despite economic headwinds, with digital transformation projects leading the increase." },
      { title: "EU Chemicals Strategy for Sustainability enters second implementation phase", source: "EU Commission", date: "2025", snippet: "New requirements on substance-of-concern reporting and safe-by-design products will apply to Belgian chemical manufacturers from mid-2026." },
      { title: "Catalisti funds €8M project for circular polymers technology", source: "Catalisti", date: "2025", snippet: "A consortium of 7 Flemish chemical companies joins forces to develop advanced recycling technology for polyolefin streams." },
    ],
  },
  "Logistics & Supply Chain": {
    ...
    headlines: [
      { title: "VIL launches open innovation platform for Belgian logistics SMEs", source: "VIL", date: "2025", snippet: "The Flemish logistics institute connects SMEs with tech scale-ups to tackle shared challenges in last-mile, visibility, and decarbonization." },
      { title: "CBAM takes effect: what Belgian logistics providers need to know", source: "EU Commission", date: "2025", snippet: "The Carbon Border Adjustment Mechanism's full reporting phase begins January 2026, affecting Belgian importers of steel, aluminium, and chemicals." },
      { title: "Port of Antwerp-Bruges pilots autonomous truck corridor with 5 logistics operators", source: "Flows.be", date: "2025", snippet: "A new pilot tests Level 4 autonomous trucks for container transport between terminals, targeting 15% efficiency gains." },
    ],
  },
  "Manufacturing & Engineering": {
    ...
    headlines: [
      { title: "Agoria pushes for €500M acceleration plan for Belgian smart manufacturing", source: "Agoria", date: "2025", snippet: "Belgian tech industry federation proposes a national investment plan to accelerate Industry 4.0 adoption among mid-sized manufacturers." },
      { title: "Flanders Make opens new research center for circular manufacturing", source: "Flanders Make", date: "2025", snippet: "The strategic research center launches a dedicated lab for disassembly, remanufacturing, and material recovery technology." },
      { title: "EU Machinery Regulation 2026: new cyber-security requirements for connected equipment", source: "European Commission", date: "2025", snippet: "Belgian machine builders must comply with new digital safety and cyber-resilience requirements by mid-2026." },
    ],
  },
  "Technology & Software": {
    facts: [
    ...
    headlines: [
      { title: "Belgian AI startups raise record funding as EU AI Act takes shape", source: "Sifted", date: "2025", snippet: "Flemish deep-tech scale-ups secure €120M in Q1 2025 as investors bet on AI companies built with regulation-by-design principles." },
      { title: "imec unveils new chiplet interconnect technology with European partners", source: "imec", date: "2025", snippet: "The research center announces a breakthrough in 3D chiplet integration, strengthening Europe's semiconductor autonomy." },
      { title: "Start it @KBC launches dedicated cyber-security accelerator cohort", source: "Start it @KBC", date: "2025", snippet: "Belgian startup accelerator opens applications for a vertical-focused program addressing NIS2, DORA, and Cyber Resilience Act challenges." },
    ],
  },
};
