  ...
  return (
    <section className="bg-white py-16 px-6">
      <div className="max-w-3xl mx-auto">
        <div className="relative border-2 border-beacon-orange/30 rounded-lg p-8 bg-beacon-orange/[0.03]">
          <div className="absolute -top-3 left-6 bg-white px-3">
            <span className="text-[10px] font-mono tracking-widest uppercase text-beacon-orange font-bold">
              What surprised us
            </span>
          </div>
