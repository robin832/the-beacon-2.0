  ...
  return (
    <section id="contact-section" className="bg-beacon-dark-teal py-20 px-6">
      <div className="max-w-2xl mx-auto space-y-8">
        <img src="/logo-white.png" alt="The Beacon" className="h-6 mx-auto opacity-30" />
        ...
        <div className="text-center">
          ...
          <div className="relative inline-block">
            <Button
              ...
              disabled={claiming || regenerating || rating === 0}
              className={rating === 0 ? 'blur-[2px] pointer-events-none opacity-60' : ''}
            >
          ...
          <p className="text-[10px] font-mono tracking-widest uppercase text-white/40 mt-4 max-w-md mx-auto leading-relaxed">
            {rating === 0
              ? 'Rate the report above to unlock your free tryout. Written feedback is optional but heavily recommended — it helps our AI improve.'
              : 'Tryout unlocked. Written feedback above is optional but heavily recommended.'}
          </p>
        </div>
      </div>
    </section>
